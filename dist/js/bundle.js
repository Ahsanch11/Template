...
var _temp_ = __webpack_require__(18);

var _temp_2 = _interopRequireDefault(_temp_);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//import/export only work at top level


//// Below for css files which will be bundled to styles.css
$(document).ready(function () {

    var a1 = __webpack_require__(18);
    console.log('....loading');
    console.log('Template for Project weorkflow');
    console.log(a1.a, '< is imported from 2nd module');
    console.log(_temp_2.default);
